...
class hasil_penilaian:
    def __init__(this):
        daftar=Tk()
        daftar.title("Hasil Penilaian")
        ...
        l_p7.grid(column=13,row=0)
        l_tot.grid(column=14,row=0)
        i=1
        j=0
        jj=0
        for ls_ni in list_nilai:
            ...
            t_c1=Label(daftar,text=('{:.2f}'.format(hasil_c1)))
            t_c2=Label(daftar,text=('{:.2f}'.format(hasil_c2)))
            t_c3=Label(daftar,text=('{:.2f}'.format(hasil_c3)))
            t_c4=Label(daftar,text=('{:.2f}'.format(hasil_c4)))
            t_c5=Label(daftar,text=('{:.2f}'.format(hasil_c5)))
            t_c6=Label(daftar,text=('{:.2f}'.format(hasil_c6)))
            t_tot=Label(daftar,text=('{:.2f}'.format(total)))
